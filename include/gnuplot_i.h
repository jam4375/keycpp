...
class Gnuplot
{
    ...
    public:
        ...
        std::string get_terminal_std() {return Gnuplot::terminal_std();};
...
inline long unsigned int& Gnuplot::tmpfile_num()
{
    static long unsigned int temp = 0;
    return temp;
}

inline std::string& Gnuplot::m_sGNUPlotFileName()
{
    #if defined(WIN32) || defined(_WIN32) || defined(__WIN32__) || defined(__TOS_WIN__)
    static std::string temp = "pgnuplot.exe";
    #elif defined(unix) || defined(__unix) || defined(__unix__) || defined(__APPLE__)
    static std::string temp = "gnuplot";
    #endif
    return temp;
}

inline std::string& Gnuplot::m_sGNUPlotPath()
{
    #if defined(WIN32) || defined(_WIN32) || defined(__WIN32__) || defined(__TOS_WIN__)
    static std::string temp = "C:/program files/gnuplot/bin/";
    #elif defined(unix) || defined(__unix) || defined(__unix__) || defined(__APPLE__)
    static std::string temp = "/usr/bin/";
    #endif
    return temp;
}

inline std::string& Gnuplot::terminal_std()
{
    #if defined(WIN32) || defined(_WIN32) || defined(__WIN32__) || defined(__TOS_WIN__)
    static std::string temp = "windows";
    #elif ( defined(unix) || defined(__unix) || defined(__unix__) ) && !defined(__APPLE__)
    static std::string temp = "x11";
    #elif defined(__APPLE__)
    static std::string temp = "aqua";
    #endif
    return temp;
}
