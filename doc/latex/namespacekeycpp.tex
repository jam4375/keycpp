...
\end{DoxyReturn}
\hypertarget{namespacekeycpp_ae9584728c5d3dc47dbedf4ca8f4dc4d2}{\index{keycpp@{keycpp}!ones@{ones}}
\index{ones@{ones}!keycpp@{keycpp}}
\subsubsection[{ones}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class T $>$ {\bf matrix}$<$T,1$>$ keycpp\-::ones (
\begin{DoxyParamCaption}
\item[{const int \&}]{N}
\end{DoxyParamCaption}
)}}\label{namespacekeycpp_ae9584728c5d3dc47dbedf4ca8f4dc4d2}
