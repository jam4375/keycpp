...
\end{DoxyReturn}
\hypertarget{namespacekeycpp_a737223780bc4bcda96ca2142a2ac3de9}{\index{keycpp@{keycpp}!size@{size}}
\index{size@{size}!keycpp@{keycpp}}
\subsubsection[{size}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class T , size\-\_\-t dim$>$ int keycpp\-::size (
\begin{DoxyParamCaption}
\item[{const matrix$<$ T, dim $>$ \&}]{A, }
\item[{const int \&}]{n}
\end{DoxyParamCaption}
)}}\label{namespacekeycpp_a737223780bc4bcda96ca2142a2ac3de9}
