...
53 \textcolor{comment}{    OdeClass myOde;}
54 \textcolor{comment}{    vector<double> t2 = linspace(0.0,12.0,100);}
55 \textcolor{comment}{    vector<double> ICs = \{0.0, 1.0, 1.0\};}
56 \textcolor{comment}{    matrix<double> y = ode45(myOde, t2, ICs);}
57 \textcolor{comment}{    }
58 \textcolor{comment}{    // Now that we have solved the ODE, lets plot the results:}
59 \textcolor{comment}{    Figure h2;}
60 \textcolor{comment}{    h2.plot(t2,y.getCol(0),"-");}
61 \textcolor{comment}{    h2.hold\_on();}
62 \textcolor{comment}{    h2.plot(t2,y.getCol(1),"-.");}
63 \textcolor{comment}{    h2.plot(t2,y.getCol(2),"x");}
64 \textcolor{comment}{    h2.xlabel("t");}
65 \textcolor{comment}{    h2.ylabel("y");}
66 \textcolor{comment}{    set(h2,"fontsize",14);}
67 \textcolor{comment}{    h2.title("ODE Solution");}
68 \textcolor{comment}{    */}
